...
<body>
	...
	<form action="?resultCap" method="post">
							...
							<table>
								<thead>
									<tr class="row100 head">
										<th class="cell100 column0">ANNUITE</th>
										<th class="cell100 column1">TAUX</th>
										<th class="cell100 column2">DUREE</th>
									</tr>
								</thead>
							</table>
						</div>
								...
								<tbody>
									<tr class="row100 body">
										...
										<td class="cell100 column2"><input type="text"
											name="duree" placeholder="Entrez  la duree  "></td>
									</tr>
